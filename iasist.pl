...
##############################################################################
## ASIST program developed at Anshu's Lab, CSIR-IMTECH, Chandigarh, India    #
#=============================================================================
use Text::CSV_XS; #(Load the module) comma-separated values manipulation routines
use Getopt::Std; # for input output arguments
...
if ($file1 ne '' && $file2 ne ''){
	...
	open (DATA, "$file1"); # read mode 
	open (OUTPUT, ">$file2"); #write mode
    ...
    print "Usage:perl $0 -i input_file.csv -o output_file.csv\n";
    print "-i\t input file in csv format\n-o\t output result file in csv format\n";
    exit;
}